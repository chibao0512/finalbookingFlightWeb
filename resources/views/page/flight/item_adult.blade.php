<div class="row item-adult">
    <div class="col-sm-12 col-md-2">
        <div class=" form-group">
            <select name="adult_genders[]" id="" class="form-control" required>
    ...
    <div class="col-sm-12 col-md-5">
        <div class=" form-group">
            <input type="text" name="adult_names[]" class="form-control" placeholder="Họ và tên" required>
        </div>
    </div>
    <div class="col-sm-12 col-md-5">
    ...
    @if ($i > 1)
        <div class="col-sm-12 col-md-2">
            <span class="item-adult-delete btn-minus-customer" url="{{ route('flight.minus.customer') }}" flight_id="{{ $flight->id }}" type="adult"><img src="{{ asset('page/images/icon/trash-can-solid.svg') }}" alt="" width="15" style="margin-top: 20px"></span>
        </div>
    @endif
    <div class="col-md-12">
        <hr>
