                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group {{ $errors->has('c_password') ? 'has-error' : '' }}">
                                        <label for="exampleInputEmail1">Old password  <sup class="title-sup">(*)</sup></label>
                                    ...
                                    <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                        <label for="exampleInputEmail1">Password <sup class="title-sup">(*)</sup></label>
                                        <input type="password" name="password" class="form-control" value="">
                                        <span class="text-danger"><p class="mg-t-5">{{ $errors->first('password') }}</p></span>
                                    </div>

                                    <div class="form-group {{ $errors->has('password_confirm') ? 'has-error' : '' }}">
                                        <label for="exampleInputEmail1">Confirm Password  <sup class="title-sup">(*)</sup></label>
